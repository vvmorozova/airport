...
def report1(table_dn,table_n3):
    ...
    Автор: Морозова Василиса, Мария Озорнина
    Входные параметры: главная таблица, таблица с характеристиками самолетов
    ...
    def ClPlot(table_dn,table_n3):
             ...
             table_dn - переменная БД.
             Автор: Морозова Василиса
             Входные параметры: главная таблица, таблица с характеристиками самолета
             Выходные параметры: нет
             """
             def save_plot():
                 """
